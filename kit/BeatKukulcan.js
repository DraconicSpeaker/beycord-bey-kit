...
class BeatKukulcan extends Beyblade {
//Set up the Bey's information. Change "Name", "Type", "Image Link" and "Special Move Name" to what they are supposed to be.
  constructor(firstOwner, id){
    super("Beat Kukulcan", "Attack", "https://vignette.wikia.nocookie.net/beyblade/images/6/65/Beyblade_Beat_Kukulcan.png/revision/latest?cb=20180716231833", "Thunder Attack, Trigger Attack", firstOwner, id);
  }
