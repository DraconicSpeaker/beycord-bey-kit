...
class Yggdrasil extends Beyblade {
//Set up the Bey's information. Change "Name", "Type", "Image Link" and "Special Move Name" to what they are supposed to be.
  constructor(firstOwner, id){
    super("Yggdrasil", "Stamina", "https://i.ibb.co/6yd3xTr/Yggdrasil.png", "Slip Launch", firstOwner, id);
  }
...
//Made by MrShadow and Draconispeaker
