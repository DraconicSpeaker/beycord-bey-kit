...
class MaximusGaruda extends Beyblade {
//Set up the Bey's information. Change "Name", "Type", "Image Link" and "Special Move Name" to what they are supposed to be.
  constructor(firstOwner, id){
    super("Maximus Garuda", "Stamina", "https://vignette.wikia.nocookie.net/beyblade/images/7/7c/Beyblade_Garuda.png/revision/latest?cb=20180716235147", "Meteor Strike", firstOwner, id);
  }
