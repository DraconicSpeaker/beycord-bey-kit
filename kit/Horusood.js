...
//Set up the Bey's information. Change "Name", "Type", "Image Link" and "Special Move Name" to what they are supposed to be.
  ...
  special(acted, victim, message, player){
    ...
    .setTitle(`[${acted.username}] Horusood used **Edge Field**. Horusood utilized it's Edge performance tip to catch the wind and boost stamina by 3, while forming a solid wall that parried the enemy's attack, reducing enemy damage by 20%.`)
    .setColor("#551a8b");
