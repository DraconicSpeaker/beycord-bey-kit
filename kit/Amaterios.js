...
class Amaterios extends Beyblade {
//Set up the Bey's information. Change "Name", "Type", "Image Link" and "Special Move Name" to what they are supposed to be.
  constructor(firstOwner, id){
    super("Amaterios", "Attack", "https://vignette.wikia.nocookie.net/beyblade/images/2/29/A_A_A.png/revision/latest?cb=20180101025729", "Aero Slash", firstOwner, id);
  }
